...
#define FULL_AUTO_300		list(mode_name="full auto",  mode_type = /datum/firemode/automatic, fire_delay = 4  , icon="auto", damage_multiplier = 0.7)
#define FULL_AUTO_400		list(mode_name="full auto",  mode_type = /datum/firemode/automatic, fire_delay = 3  , icon="auto", damage_multiplier = 0.7)
#define FULL_AUTO_600		list(mode_name="full auto",  mode_type = /datum/firemode/automatic, fire_delay = 2  , icon="auto", damage_multiplier = 0.7)
#define FULL_AUTO_800		list(mode_name="full auto",  mode_type = /datum/firemode/automatic, fire_delay = 1.6, icon="auto", damage_multiplier = 0.7)

#define SEMI_AUTO_NODELAY	list(mode_name="semiauto", burst=1, fire_delay=0, move_delay=null, icon="semi", damage_multiplier = 1)

#define BURST_3_ROUND		list(mode_name="3-round bursts", burst=3, fire_delay = 3, move_delay=4, icon="burst", damage_multiplier = 0.7)
#define BURST_5_ROUND		list(mode_name="5-round bursts", burst=5, fire_delay = 3, move_delay=6, icon="burst", damage_multiplier = 0.7)
#define BURST_8_ROUND		list(mode_name="8-round bursts", burst=8, fire_delay = 3, move_delay=8, icon="burst", damage_multiplier = 0.7)
